...
import type { Recurring, FutureObligation, Account, Goal, NwSnapshot } from "@/types"
...
export async function GET() {
  const [state, tickers, funds, splits, cardConfig, recurring, obligations, accounts, goals, nwHistory, baseRate, fxCfg] =
    await Promise.all([
      getState(),
